...
function Hero() {
  return (
    <section className='w-full min-h-[80vh] flex items-center justify-start heroBg'>
        ...
        <Button name={`Let's Get Started`} className='login my-3 py-5 px-16 bg-gray-200 text-primary text-[20px] font-semibold hover:bg-gray-300' />
