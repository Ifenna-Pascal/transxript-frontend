  ...
  return (
    <div className='flex '>
        ...
        <div className='ml-[230px] w-full py-6 px-10'>
          ...
          { step === '1' ?  <UploadCourse text="Upload Courses Details" handleChange={handleChange} step={step} setStep={setStep} form={form}/> : step === '2' ? <SelectCourse setStep={setStep} form={form} /> : <Results setStep={setStep}/> }
        </div>
    </div>
  )
}
